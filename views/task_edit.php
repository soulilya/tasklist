...
<div class="container bootstrap snippet">
    <div class="row">
    	<div class="col-sm-9">    
            ...
            <?php endif; ?>
            <hr>
            <form class="form" action="task-edit" method="post" id="createTaskForm">
                <input id="task_id" 
                       name="id" 
                       type="hidden" 
                       value="<?php if(isset($form->id)): echo $form->id; endif; ?>">
                ...
                <div class="form-check">   
                    ...
                    <div class="col-xs-6">
                        <input type="checkbox" 
                               ...
                               name="status" 
                               id="status"
                               <?php if(isset($form->status)): echo $form->status === 1 ? 'checked' : ''; endif; ?>>
